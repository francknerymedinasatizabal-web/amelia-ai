  ...
  return (
    <div className="mx-auto max-w-md space-y-8 py-12">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400">Ingresa con tu cuenta de técnico</p>
      </div>
      <motion.form
      ...
      >
        ...
        <p className="text-center text-sm text-slate-600 dark:text-slate-400">
          ¿Sin cuenta?{" "}
          <Link href="/registro" className="font-semibold text-brand-navy underline dark:text-brand-cyan">
            Registrarse
          </Link>
        </p>
      </motion.form>
